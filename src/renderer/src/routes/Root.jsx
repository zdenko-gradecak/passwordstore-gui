  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-1/3 bg-gray-200 relative flex flex-col">
        ...
        <div className="flex-1 mt-20 overflow-y-auto p-4 pt-0">
          <PassTree passwordStoreEntries={passwordStoreEntries} expandAllNodes={q?.length > 0} />
        </div>
      </div>

      <div className={`w-2/3 bg-white p-4 overflow-y-auto ${isLoading ? 'opacity-25 transition-opacity duration-200' : ''}`}>
        <Outlet />
      </div>
